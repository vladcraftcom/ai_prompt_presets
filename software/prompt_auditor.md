...
- **Языковая агностичность**: Код не должен быть жестко привязан к конкретному языку программирования. Проверка установки инструментов должна быть универсальной и предоставлять инструкции для разных операционных систем.
- **Проверка окружения**: В проекте должна быть реализована проверка наличия необходимых инструментов (компилятор, интерпретатор, менеджер пакетов) с понятными сообщениями об ошибках и инструкциями по установке.
...
- **Языковая агностичность**: Проверь, что проект не содержит жестких привязок к конкретному языку. Упоминания конкретных языков должны быть примерами, а не требованиями. Проверка инструментов должна работать для разных языков и операционных систем.
- **Инструкции по установке**: В `README.md` должны быть понятные инструкции по установке необходимых инструментов для разных операционных систем (Windows, Linux, macOS), если проект требует специфичных инструментов.